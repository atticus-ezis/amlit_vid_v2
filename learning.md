...
How to match a multiple Image instances to a single blueprint element when mulitple elment forms exist? Character, Background etc. 
...
# Problem 2 - AJAX
How to update the DOM without refreshing the page when reviewing images?
Use async functions that fetch urls - update the backend then pass the backend data to in the request body. 
